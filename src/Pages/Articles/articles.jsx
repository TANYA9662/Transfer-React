            ...
            {sortedArticles.map(article => (
                <div key={article.title} className="article-card">
                    ...
                    {article.topic.includes('Idrott') && (
                       <img src="/images/image2.jpg" alt="Idrott" />
                    )}
                    {article.topic.includes('Ekonomi') && (
                     <img src="/images/image3.jpg" alt="Ekonomi" />
                    )}
            ...
            <div>
                ...
                <footer>
                    <nav>
                        ...
                        <li><Link to="/vanliga-fragor">VanligaFragor</Link></li>
                        <li><Link to="/villkor">Villkor</Link></li>
                        <li><Link to="/bli-medlem">BliMedlem</Link></li>
                        </ul>
                    </nav>
                </footer>
            </div>           
