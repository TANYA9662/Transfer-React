            ...
            <form onSubmit={handleLogin}>
                <div>
                    <input
                        ...
                        style={inputStyle}
                        id="username" // L�gg till id-attributet h�r
                        name="username" // L�gg till name-attributet h�r
                        autoComplete="username" // L�gg till autocomplete-attributet
                    />
                </div>
                <div>
                    <input
                        ...
                        style={inputStyle}
                        id="password" // L�gg till id-attributet h�r
                        name="password" // L�gg till name-attributet h�r
                        autoComplete="current-password" // L�gg till autocomplete-attributet
                    />
                </div>
                <button
                    type="submit"
